...
class BimServerClient {
	 ...
	 * 
	 */
	 call(interfaceName, methodName, data, callback, errorCallback = null, showBusy = true, showDone = false, showError = true, connectWebSocket = true) {
